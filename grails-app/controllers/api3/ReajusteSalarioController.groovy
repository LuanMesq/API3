...
class ReajusteSalarioController {
    ...
    def list(){
        def api2Url = "http://localhost:8080/api2/ReajusteSalario/list"
    ...
    def get(Long id){
        def api2Url = "http://localhost:8080/api2/ReajusteSalario/get/${id}"
        def response = sendRequestToApi2Get(api2Url)
        def json = new JSON().parse(response)
        respond(json)
    }
    ...
    def save(){
        ...
        def api2Url = "http://localhost:8080/api2/ReajusteSalario/save"
    ...
    def update(Long id){
        def requestData = request.JSON
        def api2Url = "http://localhost:8080/api2/ReajusteSalario/update/${id}"
    ...
    def delete(Long id){
        def api2Url = "http://localhost:8080/api2/ReajusteSalario/delete/${id}"
